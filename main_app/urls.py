...
urlpatterns = [
    ...
    path('pets/<int:pet_id>/vaccinationdetail/', views.PetVaccinationDetail, name='pet_vaccinationdetail'),
    path('pets/<int:pet_id>/addvaccination/', views.PetAddVaccinationView, name='pet_addvaccination'),
